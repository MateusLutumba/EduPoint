...
if(!empty($_POST)){
   /* print($_POST['nome']);
    ...
    $sql = "INSERT INTO universidades (nome, ensino, endereco, horario, contacto, desc_matricula)
        ...
        <div class="fr">
            ...
            <form action="" method="POST">
                ...
                <div class="preechimento">
                    ...
                    <input type="tel" name="contacto" id="" placeholder="ex: 999 999 999" required><br>
                    <textarea name="descricao" id="" cols="80" rows="12" placeholder="Descrição da matrícula" ></textarea>
                </div>
                <div class="botao">
